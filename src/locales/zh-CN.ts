export default {
  common: {
    ...
    document: '项目文档',
    reminder: '温馨提示',
    loginOutMessage: 'خروج من النظام؟',
    back: 'عودة',
    ok: 'موافق',
    cancel: 'إلغاء',
    reload: '重新加载',
  ...
  login: {
    welcome: 'أهلا بك',
    message: 'موقع إدارة الشركة',
    username: 'اسم المستخدم',
    password: 'كلمة السر',
    register: 'تسجيل حساب جديد',
    checkPassword: 'تأكيد كلمة السر',
    login: 'تسجيل دخول',
    otherLogin: 'دخول باستخدام',
    remember: 'تذكر اختياري',
    hasUser: 'لديك حساب؟ عودة لتسجيل الدخول',
    forgetPassword: 'نسيت كلمة السر',
    usernamePlaceholder: 'أدخل اسم المستخدم',
    passwordPlaceholder: 'أدخل كلمة السر',
    code: 'كود التفعيل',
    codePlaceholder: 'أدخل كود تفعيل الحساب'
  },
  router: {
    home: 'الصفحة الرئيسية',
    about: 'حول التطبيق',
    login: 'دخول',
    level: 'الموارد البشرية',
    menu: 'قائمة',
    menu1: 'ذاتية الموظفين',
    menu11: 'إضافة موظف',
    menu111: '菜单1-1-1',
    menu12: 'قائمة الموظفين',
    menu2: 'مراقبة الدوام',
    dashboard: '首页',
    analysis: '分析页',
    workplace: '工作台',
  ...
  levelDemo: {
    ...
    welcome: 'أهلا بك في النظام',
    about: 'معلومات حول التطبيق'
  },
  searchDemo: {
    search: '查询',
